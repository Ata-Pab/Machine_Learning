'''
This file contains useful functions for the implementation of YOLOv3.
'''
...
used in object detection algorithms to eliminate redundant bounding 
box predictions. The purpose of NMS is to suppress multiple overlapping
bounding boxes for the same object and keep only the most confident and 
...
def non_max_suppression(inputs, model_size, max_output_size, 
    ...
    where (y1, x1) and (y2, x2) are the coordinates of any diagonal pair of box corners and 
    the coordinates can be provided as normalized 
    '''
