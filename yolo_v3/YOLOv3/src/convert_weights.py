...
def load_weights(model,cfgfile,weightfile):
    ...
    for i, block in enumerate(blocks[1:]):
        # As we did when building the YOLOv3 network, 
        # we need to loop over the blocks and search for 
...
def main():
    ...
    weightfile = "/content/drive/MyDrive/MASTER/Master_Thesis/YOLO/PROJECTS/YOLOv3/weights/yolov3.weights"  # Google Colab edit
    # cfgfile = "cfg/yolov3.cfg"
    cfgfile = "/content/drive/MyDrive/MASTER/Master_Thesis/YOLO/PROJECTS/YOLOv3/cfg/yolov3.cfg"   # Google Colab edit
    ...
    try:
        ...
        model.save_weights('/content/drive/MyDrive/MASTER/Master_Thesis/YOLO/PROJECTS/YOLOv3/weights/yolov3_weights.tf')  # Google Colab edit
